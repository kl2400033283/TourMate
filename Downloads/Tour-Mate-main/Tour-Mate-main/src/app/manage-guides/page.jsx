...
function GuidesTable({ guides, isLoading, onUpdateStatus }) {
  ...
  if (!guides || guides.length === 0) {
      return <p className="p-4 text-center text-muted-foreground">No guides found.</p>;
  }
...
export default function ManageGuidesPage() {
  ...
  useEffect(() => {
    ...
    if (!user) {
      router.replace('/login?redirect=/manage-guides');
      return;
    }
        ...
        <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
          <div className="mb-4">
            ...
            <p className="text-muted-foreground mt-1">
              View, verify, and manage all tour guides on the platform.
            </p>
          </div>
          <Card>
            <CardHeader>
