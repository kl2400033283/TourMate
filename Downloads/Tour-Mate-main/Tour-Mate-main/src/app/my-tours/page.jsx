...
function ToursTable({ bookings, isLoading }) {
  if (isLoading) {
    return (
            ...
            <div className="flex flex-col bg-background">
                ...
                <main className="flex flex-1 flex-col gap-4 p-4 lg:gap-6 lg:p-6">
                    <div className="flex items-center">
                        <div>
                            <h1 className="text-lg font-semibold md:text-2xl">My Tours</h1>
                             <p className="text-sm text-muted-foreground">
                                View and manage all your client tours.
                            </p>
                        </div>
                    </div>
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>A complete list of all tours requested by clients.</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <ToursTable bookings={bookings} isLoading={bookingsLoading} />
                        </CardContent>
                    </Card>
                </main>
            </div>
